...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 600px) { nav { padding: 12px 16px; } main { padding: 32px 16px; } }
    </style>
</head>
<body>
...
<footer>
    <div class="footer-inner">
        <a href="/" class="footer-logo"><img src="{{ asset('images/logo-tema-escuro.svg') }}" alt="Logo"></a>
        <div class="footer-bottom"><span class="footer-copy">© 2026 GiftZone Todos direitos Reservados</span></div>
    </div>
</footer>
